...
const Hero: React.FC = () => {
  return (
    <section className="max-w-2xl mx-auto border-b py-12">
      ...
      <button className="flex items-center gap-2 group bg-white text-black px:4 py-2 md:px-6 md:py-3 rounded-md mt-5 cursor-pointer transition-all duration-500">
        Let&#39;s Connect 
