  ...
  return (
    <section>
      <div className="">
        ...
        <h3 className="text-xl font-semibold font-outfit mb-2">Frontend Developer</h3>
      ...
      <button className="flex items-center gap-2 group bg-white text-black text-[14px] font-normal px-3 py-2 md:px-6 md:py-3 rounded-md mt-5 cursor-pointer transition-all duration-500">
        Let&#39;s Connect 
