...
const Navbar: React.FC = () => {
  return (
    <section className="w-full flex justify-center items-center mb-5">
      <nav className="backdrop-blur-md max-w-2/4 w-5xl fixed flex-nav border border-white rounded-full z-50">
        {/* HOME */}
        ...
        {/* RESUME */}
        <Link href="/Resume.pdf" download={"NathanielIdyege_Resume"} className="group relative inline-block">
